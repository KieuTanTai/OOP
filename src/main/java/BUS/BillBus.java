...
public class BillBus{
    ...
    public void searchBillId(String newbd){
        boolean flag = false;
        for(int i = 0; i < n; ++i){
    ...
    public void searchEmployeeId(String neweid){
        boolean flag = false;
        for(int i = 0; i < n; ++i){
    ...
    public void searchCustomerId(String newcid){
        boolean flag = false;
        for(int i = 0; i < n; ++i){
    ...
    public void searchTotalPrice(BigDecimal newtotal){
        boolean flag = false;
        for(int i = 0; i < n; ++i){
